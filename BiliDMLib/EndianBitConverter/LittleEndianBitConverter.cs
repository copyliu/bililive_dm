...
{
    /// <summary>
    ///     A little-endian BitConverter that converts base data types to an array of bytes, and an array of bytes to base data
    ///     types. All conversions are in
    ...
    internal class LittleEndianBitConverter : EndianBitConverter
    {
        ...
        public override int ToInt32(byte[] value, int startIndex)
        {
            ...
            return value[startIndex] | (value[startIndex + 1] << 8) | (value[startIndex + 2] << 16) |
        ...
        public override long ToInt64(byte[] value, int startIndex)
        {
            ...
            var lowBytes = value[startIndex] | (value[startIndex + 1] << 8) | (value[startIndex + 2] << 16) |
                           (value[startIndex + 3] << 24);
            var highBytes = value[startIndex + 4] | (value[startIndex + 5] << 8) | (value[startIndex + 6] << 16) |
