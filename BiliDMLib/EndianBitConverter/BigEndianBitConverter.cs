...
{
    /// <summary>
    ///     A big-endian BitConverter that converts base data types to an array of bytes, and an array of bytes to base data
    ...
    internal class BigEndianBitConverter : EndianBitConverter
    {
        ...
        public override long ToInt64(byte[] value, int startIndex)
        {
            ...
            var highBytes = (value[startIndex] << 24) | (value[startIndex + 1] << 16) | (value[startIndex + 2] << 8) |
                            value[startIndex + 3];
            var lowBytes = (value[startIndex + 4] << 24) | (value[startIndex + 5] << 16) |
