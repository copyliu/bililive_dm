...
namespace Bililive_dm.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   查找类似 非B站出品 ©2014-2024 CopyLiu 放棄所有權利 房間編號5051 問題反饋 copyliu@gmail.com 的本地化字符串。
        /// </summary>
        ...
        ///   查找类似 檔案名 的本地化字符串。
        /// </summary>
        public static string DataGridTextColumn_Header_Plugin6 {
            get {
                return ResourceManager.GetString("DataGridTextColumn.Header.Plugin6", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 B站開放平台通知: 本次使用已結束, 請重新連線. 的本地化字符串。
        /// </summary>
